...
export const en: Translations = {
  ...
  partnerChallenges: {
    ...
    pageSubtitle: 'Create and manage challenges for your network.',
    newChallenge: 'New Challenge',
    newChallengeTitle: 'Create New Challenge',
    newChallengeSubtitle: 'Create a custom challenge for your network.',
    ...
    noChallenges: 'You have not created any challenges yet. Start now!',
    formTitleDe: 'Title (German)',
    formTitleEn: 'Title (English, optional)',
    formDescriptionDe: 'Description (German)',
    formDuration: 'Duration',
    formDifficulty: 'Difficulty',
    formTargetTypes: 'Target Types',
    formVisibility: 'Visibility',
    visibilityDirect: 'Direct partners only',
    visibilityDownline: 'Full downline',
    durationDays: 'Days',
    difficultyEasy: 'Easy',
    difficultyMedium: 'Medium',
    difficultyHard: 'Hard',
    dayModuleTitle: 'Day Modules',
    dayTitle: 'Day Goal',
    dayTaskDescription: 'Task Description',
    dayRestToggle: 'Rest Day',
    dayWorkoutSelect: 'Select Workout',
    dayWorkoutNone: 'No Workout',
    saveChallenge: 'Save Challenge',
    saving: 'Saving...',
    savedSuccess: 'Challenge saved successfully!',
    errorMinDays: 'At least 3 days must be filled out.',
    errorDayTitle: 'Every day needs a title.',
    errorTitleLength: 'Title must be at least 10 characters long.',
    errorTitleRequired: 'Please enter a title.',
    errorGeneric: 'Something went wrong. Please try again.',
    statsTitle: 'Challenge Statistics',
    statsEnrollments: 'Enrollments',
    statsAvgProgress: 'Average Progress',
    statsCompletionRate: 'Completion Rate',
    statsDropouts: 'Dropouts',
    backToList: 'Back to overview',
    targetLeererAkku: 'Empty Battery',
    targetFunktionierer: 'Operator',
    targetStillerKaempfer: 'Silent Fighter',
    targetPerformerAufReserve: 'Performer on Reserve',
  },

  network: {
    pageTitle: 'My Network',
    backToPartner: 'Back to Partner Dashboard',
    statTotal: 'Total in Downline',
    statActive: 'Active Partners',
    statDirect: 'Direct Partners (Level 1)',
    statNewThisWeek: 'New This Week',
    maxDepthWarning: 'Your network has more than 5 levels. Deeper levels may slow down rendering.',
    emptyTree: 'No partners in your downline yet.',
    levelLabel: 'Level',
    statusActive: 'Active',
  ...
  tokenManager: {
    title: 'Invite Links',
    createTitle: 'Create New Invite Link',
    labelField: 'Label',
    labelPlaceholder: 'e.g. For WhatsApp group March',
    maxUsesField: 'Max Uses',
    ...
    statusMaxUsed: 'Max reached',
    whatsappText: 'Hey! Join the daddypower community. Here is your invite link: {link}',
    errorGeneric: 'Something went wrong. Please try again.',
  },
  ...
  license: {
    ...
    progressText: '{count} more partners until {tier} ({price} EUR/month)',

...
export const de: Translations = {
  ...
  partnerChallenges: {
    pageTitle: 'Deine Challenges',
    pageSubtitle: 'Erstelle und verwalte Challenges fuer dein Netzwerk.',
    newChallenge: 'Neue Challenge',
    newChallengeTitle: 'Neue Challenge erstellen',
    newChallengeSubtitle: 'Erstelle eine individuelle Challenge fuer dein Netzwerk.',
    statusWaiting: 'Wartet auf Freigabe',
    statusActive: 'Aktiv',
    statusPaused: 'Pausiert',
    enrollments: 'Teilnehmer',
    editButton: 'Bearbeiten',
    statsButton: 'Statistiken',
    deleteButton: 'Loeschen',
    deleteConfirm: 'Moechtest du diese Challenge wirklich loeschen?',
    noChallenges: 'Du hast noch keine Challenges erstellt. Starte jetzt!',
    formTitleDe: 'Titel (Deutsch)',
    formTitleEn: 'Titel (Englisch, optional)',
    formDescriptionDe: 'Beschreibung (Deutsch)',
    formDuration: 'Dauer',
    formDifficulty: 'Schwierigkeit',
    formTargetTypes: 'Zielgruppen',
    formVisibility: 'Sichtbarkeit',
    visibilityDirect: 'Nur direkte Partner',
    visibilityDownline: 'Gesamte Downline',
    durationDays: 'Tage',
    difficultyEasy: 'Leicht',
    difficultyMedium: 'Mittel',
    difficultyHard: 'Schwer',
    dayModuleTitle: 'Tagesmodule',
    dayTitle: 'Tagesziel',
    dayTaskDescription: 'Aufgabenbeschreibung',
    dayRestToggle: 'Ruhetag',
    dayWorkoutSelect: 'Workout auswaehlen',
    dayWorkoutNone: 'Kein Workout',
    saveChallenge: 'Challenge speichern',
    saving: 'Wird gespeichert...',
    savedSuccess: 'Challenge wurde gespeichert!',
    errorMinDays: 'Mindestens 3 Tage muessen ausgefuellt sein.',
    errorDayTitle: 'Jeder Tag braucht einen Titel.',
    errorTitleLength: 'Der Titel muss mindestens 10 Zeichen lang sein.',
    errorTitleRequired: 'Bitte gib einen Titel ein.',
    errorGeneric: 'Etwas ist schiefgelaufen. Bitte versuche es erneut.',
    statsTitle: 'Challenge Statistiken',
    statsEnrollments: 'Einschreibungen',
    statsAvgProgress: 'Durchschnittlicher Fortschritt',
    statsCompletionRate: 'Abschlussrate',
    statsDropouts: 'Abbrecher',
    backToList: 'Zurueck zur Uebersicht',
    targetLeererAkku: 'Leerer Akku',
    targetFunktionierer: 'Funktionierer',
    targetStillerKaempfer: 'Stiller Kaempfer',
    targetPerformerAufReserve: 'Performer auf Reserve',
  },

  network: {
    pageTitle: 'Mein Netzwerk',
    backToPartner: 'Zurueck zum Partner-Dashboard',
    statTotal: 'Gesamt in Downline',
    statActive: 'Aktive Partner',
    statDirect: 'Direkte Partner (Level 1)',
    statNewThisWeek: 'Neu diese Woche',
    maxDepthWarning: 'Dein Netzwerk hat mehr als 5 Ebenen. Tiefere Ebenen koennen die Darstellung verlangsamen.',
    emptyTree: 'Noch keine Partner in deiner Downline.',
    levelLabel: 'Level',
    statusActive: 'Aktiv',
  ...
  tokenManager: {
    ...
    createTitle: 'Neuen Einladungslink erstellen',
    labelField: 'Bezeichnung',
    labelPlaceholder: 'z.B. Fuer WhatsApp-Gruppe Maerz',
    maxUsesField: 'Max. Nutzungen',
    maxUsesPlaceholder: 'Unbegrenzt',
    expiryField: 'Ablaufdatum',
    createButton: 'Einladungslink erstellen',
    noTokens: 'Noch keine Einladungslinks erstellt.',
    copyLink: 'Link kopieren',
    copied: 'Kopiert!',
    ...
    statusMaxUsed: 'Max. erreicht',
    whatsappText: 'Hey! Werde Teil der daddypower Community. Hier ist dein Einladungslink: {link}',
    errorGeneric: 'Etwas ist schiefgelaufen. Bitte versuche es erneut.',
  },

  license: {
    title: 'Dein Lizenz-Status',
    currentTier: 'Aktuelles Tier',
    freeTier: 'Kostenlos',
    activeDownline: 'Aktive Downline',
    progressText: 'Noch {count} Partner bis {tier} ({price} EUR/Monat)',
